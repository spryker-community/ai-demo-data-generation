...
use Pyz\Shared\ErrorHandler\ErrorRenderer\WebHtmlErrorRenderer;
...
$config[OpenAiConstants::OPENAI_API_DEBUG_ERROR_RENDERER_PROMPT_NAME] = 'Given the PHP class data, your task is to explain this exception. Please exclude any comments or extraneous text from your response.';
$config[OpenAiConstants::OPENAI_API_DEBUG_ERROR_RENDERER_PROMPT_NAME_5_YEARS] = 'Explain me like i am 5.';
