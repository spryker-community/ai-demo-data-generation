...
//            ->addLocaleField($builder, $options[static::OPTION_LOCALE_CHOICES])
            ...
            ->addTextField($builder, OpenAiPromptTransfer::MODEL, 'gpt-3.5-turbo')
            ->addTextField($builder, OpenAiPromptTransfer::MAX_TOKENS, '16', false)
            ->addTextField($builder, OpenAiPromptTransfer::TEMPERATURE, '1', false)
            ->addTextField($builder, OpenAiPromptTransfer::TOP_P, '1', false)
            ->addTextField($builder, OpenAiPromptTransfer::N_COMPLETIONS, '1', false)
            ->addTextField($builder, OpenAiPromptTransfer::STOP, 'null', false)
            ->addTextField($builder, OpenAiPromptTransfer::PRESENCE_PENALTY, '0', false)
            ->addTextField($builder, OpenAiPromptTransfer::FREQUENCY_PENALTY, '0', false)
            ->addTextField($builder, OpenAiPromptTransfer::USER, 'spryker-gpt', false)
