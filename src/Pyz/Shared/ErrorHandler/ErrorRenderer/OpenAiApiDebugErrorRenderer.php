...
class OpenAiApiDebugErrorRenderer implements ErrorRendererInterface
{
    /**
    ...
    public function render($exception)
    {
        ...
        try {
            ...
            $errorPromptEvent = Config::get(OpenAiConstants::OPENAI_API_DEBUG_ERROR_RENDERER_PROMPT_NAME);
